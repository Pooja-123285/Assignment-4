...
<centre>
    ...
    <form method="post" action="#">
        <table border="0">            
            ...
            <tr>
                <td>Employee Category</td><td><input type="radio" name="cate" id="cate" value="part_time"  onChange="findselected(this.value)"/>Part Time
                    <input type="radio" name="cate"  id="cate" value="full_time"  onChange="findselected(this.value)" />Full Time
                    <input type="radio" name="cate"  id="cate" value="contract"   onChange="findselected(this.value)"/>Contract</td>
            </tr>
            <tr id="hrs" >
